...
class Har extends React.Component {
  ...
  getDataFromGoogleSheet = () => {
    ...
    const url1 = `${scriptUrl1}?callback=ctrlq&action=${'doGetHarData'}`;
  ...
  getCheckListFromGoogle = () => {
    ...
    const scriptUrl1 = 'https://script.google.com/macros/s/AKfycbymOKlhOo1RztVgk_J35pzX3WOMID2Zw0UuPe6pYGxB9OvjCiXf/exec';
    const url1 = `${scriptUrl1}?callback=ctrlq&action=${'doGetChecklistHarData'}`;
      ...
      buttons: [
        {
          ...
          onClick: () => {
            ...
            const url = `${scriptUrl}?
          callback=ctrlq&action=${'doDeleteHarNames'}&delete_names=${deleteNames}`;
  ...
  sendData(valueName, valueJob, valueTL, combinedValue) {
    ...
    const scriptUrl = 'https://script.google.com/macros/s/AKfycbymOKlhOo1RztVgk_J35pzX3WOMID2Zw0UuPe6pYGxB9OvjCiXf/exec';
    const url = `${scriptUrl}?
    callback=ctrlq&action=${'doPostAssignJobsHarData'}&assign_jobs_name=${valueName}&assign_jobs_job=${valueJob}&assign_jobs_TL=${valueTL}&assign_jobs=${combinedValue}`;
